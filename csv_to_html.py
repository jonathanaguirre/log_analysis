#!/usr/bin/env python3
# The purpose of this script is to convert csv files to html.
import sys
import csv
import os
...
if __name__ == "__main__":
    main()
student-02-f69fa7be63cf@linux-instance:~$ nano csv_to_html.py
  GNU nano 2.7.4                              File: csv_to_html.py
